    ...
    <nav class="navbar navbar-expand-lg header-transparent bg-transparent header-reverse glass-effect" data-header-hover="light">
        <div class="container-fluid"> 
            ...
            <div class="col-auto col-lg-6 menu-order position-static">
                <button class="navbar-toggler float-start" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-label="Toggle navigation menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="/endpoint-security/data-leakage-prevention"><i class="bi bi-file-lock text-dark icon-small me-10px"></i>Data Leakage Prevention (DLP)</a></li>
                                        <li><a href="/endpoint-security/email-security"><i class="bi bi-envelope-exclamation text-dark icon-small me-10px"></i>Email Security</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="/backup-and-recovery/cloud-backup"><i class="bi bi-cloud-arrow-up text-dark icon-small me-10px"></i>Cloud Backup</a></li>
                                        <li><a href="/backup-and-recovery/disaster-recovery"><i class="bi bi-tsunami text-dark icon-small me-10px"></i>Disaster Recovery</a></li>
                                        <li><a href="/backup-and-recovery/nas-storage"><i class="bi bi-hdd-network text-dark icon-small me-10px"></i>Network Attached Storage (NAS)</a></li>
                                    </ul>
                                </li>
