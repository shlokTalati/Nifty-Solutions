<?php $page_title="Network Monitoring and Ticketing Software" ?>
<!-- start page title -->
    <section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/network-monitoring/network-monitoring-inner.png');">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center h-500px sm-h-300px">
                <div class="col-12 col-lg-8 col-md-10 position-relative text-center page-title-extra-large d-flex flex-wrap flex-column align-items-center justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <h1 class="mb-0 text-white fw-600 ls-minus-1px">Network Monitoring & Ticketing</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <figure class="position-relative m-0">
                        <img src="/public/images/network-monitoring/network-monitoring1.jpg" alt="Network Monitoring" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-md-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex justify-content-center justify-content-md-start"><i class="bi bi-award fs-16 me-5px"></i>Advanced Network Monitoring & Ticketing</span>
                    ...
                    <div class="w-100 min-h-300px text-center rotate-box to-left">
                        ...
                        <div class="w-100 h-100 overflow-hidden z-index-1 front-side bg-white border-radius-6px box-shadow-quadruple-large">
                            <div class="rotate-content-front z-index-2 p-30px">
                                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px"> Motadata</div>
                                <span>Motadata offers unified IT monitoring, log management, and network performance analytics to streamline operations and ensure service uptime.</span>
                            </div>
                        </div>
                        <!-- end front side -->
                        <!-- start back side -->
                        <div class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large" style="background-image:url('/public/images/network-monitoring/motadata.jpg')">
                            ...
                            <div class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                                ...
                                <a href="https://www.motadata.com/" target="_blank" class="btn btn-medium btn-rounded with-rounded btn-base-color btn-box-shadow">Learn more<span class="bg-white text-base-color"><i class="feather icon-feather-arrow-right"></i></span></a>
                            </div>
                            <!-- end back side -->
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
                    <div class="col-xl-5 col-lg-6 col-md-12 md-mb-50px" data-anime='{ "el": "childs", "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                        ...
                        <h3 class="fw-700 text-dark-gray ls-minus-1px">Benefits of using Network Monitoring & Ticketing</h3>
                        ...
                        <div class="icon-with-text-style-08 mb-10px">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                ...
                                <div class="feature-box-content">
                                    <span class="text-dark-gray fw-500">Proactive Issue Detection</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="icon-with-text-style-08 mb-10px">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                ...
                                <div class="feature-box-content">
                                    <span class="text-dark-gray fw-500">Faster Troubleshooting & Resolution</span>
                                </div>
                            </div>
                        </div>
                        <!-- end features box item -->
                        ...
                        <div class="icon-with-text-style-08 mb-10px">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                ...
                                <div class="feature-box-content">
                                    <span class="text-dark-gray fw-500">Better Resource Management</span>
                                </div>
                            </div>
                        </div>
                        <!-- end features box item -->
                        ...
                        <div class="icon-with-text-style-08 mb-10px">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                ...
                                <div class="feature-box-content">
                                    <span class="text-dark-gray fw-500">Improved Accountability & Documentation</span>
                                </div>
                            </div>
                        </div>
                        <!-- end features box item -->
                        ...
                        <div class="icon-with-text-style-08 mb-10px">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                ...
                                <div class="feature-box-content">
                                    <span class="text-dark-gray fw-500">Enhanced User Satisfaction</span>
                                </div>
                            </div>
                        </div>
                        <!-- end features box item -->
                            ...
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner">
                                        <img src="/public/images/network-monitoring/network-monitoring-draw.jpg" alt="Network Monitoring Drawing" class="border-radius-6px w-100" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="col-12">
                    <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                        <div class="position-absolute right-70px lg-right-20px top-minus-20px w-250px sm-w-180px xs-w-150px opacity-1"><img src="/public/images/network-monitoring/network-monitoring-icon.png" alt="Network Monitoring Icon"></div>
                        <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-light-gray-transparent d-inline-flex"><i class="bi bi-patch-check fs-16 me-5px"></i>Basic information of Network Monitoring & Ticketing</span>
                                ...
                                <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                    <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-01" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                        <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                            <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Motadata</span>
                                        </div>
                                    </a>
                                </div>
                                <div id="accordion-style-02-01" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                    <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                        <p> <b>Key Features</b><br><br>
                                            ...
                                            <b>1. Motadata AIOps (Artificial Intelligence for IT Operations)</b><br><br>
                                        <ul>
                                            <li><b>Network Observability:</b> Provides real-time monitoring and AI-driven correlation tools for analyzing an organization's entire network, including on-premises, cloud, and hybrid infrastructures.</li>
                                            <li><b>Infrastructure Monitoring:</b> Offers centralized observability for various IT infrastructures, enabling proactive management and optimization.</li>
                                            <li><b>Log Analytics:</b> Analyzes machine data to identify trends and patterns, providing actionable business insights.</li>
                                            <li><b>Network Automation:</b> Allows the creation of runbooks to automate repetitive tasks, enhancing efficiency and reducing human error.</li>
                                        </ul><br>

                                        <b>2. Motadata ServiceOps (ITSM)</b><br><br>
                                        <ul>
                                            <li><b>Service Desk Automation:</b> Streamlines IT service delivery using AI-powered automation, improving response times and service quality.</li>
                                            <li><b>Asset Management:</b> Helps track both IT and non-IT asset inventories, ensuring accurate records and compliance.</li>
                                            <li><b>Patch Management:</b> Automates patch management processes to safeguard endpoints from vulnerabilities.</li>
                                            <li><b>ITIL Compliance:</b> Aligns with ITIL best practices, supporting processes like incident, problem, change, and release management.</li>
                                        </ul><br>

                                        <b>3. DFIT Platform</b><br><br>
                                        <ul>
                                            <li>A proprietary framework that incorporates AI and machine learning to enhance IT operations, aiming to increase efficiency and reduce operational costs.</li>
                                        </ul><br>

                                        <b>Solutions by Use Case</b><br><br>
                                        <ul>
                                            <li><b>Cloud Monitoring:</b> Ensures optimal performance and availability of cloud-based services and applications.</li>
                                            <li><b>Log Monitoring:</b> Provides tools to monitor and analyze log data, aiding in troubleshooting and performance tuning.</li>
                                            <li><b>Hybrid IT Monitoring:</b> Offers visibility across on-premises and cloud environments, facilitating seamless management.</li>
                                            <li><b>NetOps:</b> Supports network operations with tools for monitoring, automation, and optimization.</li>
                                            <li><b>ITSM for MSPs:</b> Tailored solutions for
                                                to be given by Manav / Shlok
