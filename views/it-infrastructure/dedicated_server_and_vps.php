...
<!-- start page title -->
<section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/dedicated-vps/dedicated-vps-inner.webp');">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center h-500px sm-h-300px">
            <div class="col-12 col-lg-8 col-md-10 position-relative text-center page-title-extra-large d-flex flex-wrap flex-column align-items-center justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <h1 class="mb-0 text-white fw-600 ls-minus-1px">Dedicated Server & VPS</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
            <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <figure class="position-relative m-0">
                    <img src="/public/images/dedicated-vps/dedicated-vps1.webp" alt="VPS" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                </figure>
            </div>
            <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-md-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex justify-content-center justify-content-md-start"><i class="bi bi-award fs-16 me-5px"></i>Advanced Dedicated Server & VPS</span>
                <h3 class="text-dark-gray fw-700 ls-minus-1px">Hosting for Apps, Sites, Databases</h3>
                <p class="w-95 md-w-100">A dedicated server is the best solution when performance, privacy, and customization are critical for your operations.
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center" data-anime='{ "el": "childs", "willchange": "transform", "scale":[0.95,1], "opacity": [0, 1], "duration": 800, "delay": 100, "staggervalue": 300, "easing": "easeOutQuad" }'>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-15 pe-15 lg-ps-8 lg-pe-8 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="bi bi-cloud-check text-base-color icon-extra-large text-light-opacity mb-25px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block text-dark-gray fw-600 fs-17 mb-5px">VPS Cloud Hosting</span>
                        <p class="text-light-opacity">Get cost-effective, scalable hosting with dedicated resources, root access, and high flexibility—ideal for apps, databases, ERPs, or websites.</p>
                    </div>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-15 pe-15 lg-ps-8 lg-pe-8 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="bi bi-server text-base-color icon-extra-large text-light-opacity mb-25px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block text-dark-gray fw-600 fs-17 mb-5px">Dedicated Servers</span>
                        <p class="text-light-opacity">Enjoy full control, enhanced security, and enterprise-level performance with our customizable, high-uptime dedicated servers.
</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all xs-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-15 pe-15 lg-ps-8 lg-pe-8 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="bi bi-ubuntu text-base-color icon-extra-large text-light-opacity mb-25px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block text-dark-gray fw-600 fs-17 mb-5px">Windows & Linux Environments</span>
                        <p class="text-light-opacity">Choose the OS that suits your workload—our servers support both Windows and Linux platforms for total deployment freedom.
</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all xs-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-15 pe-15 lg-ps-8 lg-pe-8 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="bi bi-code-square text-base-color icon-extra-large text-light-opacity mb-25px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block text-dark-gray fw-600 fs-17 mb-5px">Custom Software Hosting</span>
                        <p class="text-light-opacity">Host everything from email solutions to mobile apps—install what you need, how you need it, on reliable infrastructure.
                    ...
                    <div class="atropos-scale">
                        <div class="atropos-rotate">
                            <div class="atropos-inner">
                                <img src="/public/images/dedicated-vps/dedicated-vps-draw.webp" alt="VPS Drawing" class="border-radius-6px w-100" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center mt-8 sm-mt-40px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
            <div class="col-12">
                <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                    <div class="position-absolute right-70px lg-right-20px top-minus-20px w-250px sm-w-180px xs-w-150px opacity-1"><img src="/public/images/dedicated-vps/dedicated-vps-icon.webp" alt="VPS Icon"></div>
                            ...
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-01" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Hosting on Windows & Linux - VPS and Dedicated Servers</span>
                                    </div>
                                </a>
                            </div>
                            <div id="accordion-style-02-01" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p><b>We provide Virtual Private Servers (VPS) and Dedicated Servers on both Windows and Linux environments, tailored to meet a wide range of hosting needs.</b><br><br>
                                        Whether you're looking to host:
                                    <ul>
                                    ...
                                    <b>...our robust infrastructure ensures reliability, performance, and flexibility.</b>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-02" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Virtual Private Server (VPS) Cloud Hosting</span>
                                    </div>
                                </a>
                            </div>
                            <div id="accordion-style-02-02" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p><b>A Virtual Private Server (VPS) offers the perfect balance between performance, control, and affordability, making it an ideal hosting solution for small to medium-sized businesses.</b><br><br>
                                        Unlike shared hosting, VPS provides dedicated resources such as guaranteed RAM and disk space, ensuring consistent performance. While being cost-effective, it delivers a level of control and flexibility comparable to that of a dedicated server.<br><br>
                                        Each VPS instance functions like an independent server:
                                    <ul>
                                        <li>Full root access</li>
                                        <li>Customizable files and processes</li>
                                        <li>Dedicated IP addresses</li>
                                        <li>Capability to reboot independently</li>
                                        <li>Freedom to install complex applications</li>
                                        <li>Modify any file or system configuration</li>
                                    </ul>
                                    <b>With VPS Cloud Hosting, you get the security, scalability, and performance you need�without overextending your IT budget.</b>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-03" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Dedicated Servers</span>
                                    </div>
                                </a>
                            </div>
                            <div id="accordion-style-02-03" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p><b>A Dedicated Server offers unmatched control, security, and performance, making it the preferred choice for businesses with advanced hosting needs.</b><br><br>
                                        This type of hosting provides exclusive access to a physical server fully allocated to a single customer. The hardware is leased from the hosting provider, along with essential services such as network monitoring, high-speed internet bandwidth, and routing infrastructure.<br><br>

                                        <b>Key Features:</b>
                                    <ul>
                                        <li>Comes with a minimum of 1 dedicated IP address</li>
                                        <li>Full access via SSH or Remote Desktop</li>
                                        <li>Install custom software and applications as needed</li>
                                        <li>Guaranteed 99.9% Network Uptime</li>
                                        <li>Flexible storage options: choose between SATA or SSD drives</li>
                                        <li>Optional control panels: cPanel or Plesk available at additional cost</li>
                                    </ul>

                                    <b>A dedicated server is the best solution when performance, privacy, and customization are critical for your operations.</b>
