...
<!-- start page title -->
    <section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/hardware-network/hardware-network-inner.webp');">
            ...
            <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <figure class="position-relative m-0">
                        <img src="/public/images/hardware-network/hardware-network1.webp" alt="Hardware Network and AMC" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
        ...
        <!-- end section -->
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
                            <div class="col-xl-5 col-lg-6 col-md-12 md-mb-50px" data-anime='{ "el": "childs", "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                                ...
                                <h3 class="fw-700 text-dark-gray ls-minus-1px">Benefits of using Computer Hardware, Network & AMC</h3>
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">25+ Years of Industry Experience</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Certified Technicians & Network Engineers</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Fast Response Time & Onsite Support</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Trusted Partners for Leading IT Brands</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Customized Solutions Based on Business Needs</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                    ...
                                    <div class="atropos-scale">
                                        <div class="atropos-rotate">
                                            <div class="atropos-inner">
                                                <img src="/public/images/hardware-network/hardware-network-draw.webp" alt="Hardware Network and AMC Drawing" class="border-radius-6px w-100" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="bg-very-light-gray overlap-height position-relative">
                    <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                                                <div class="position-absolute right-70px lg-right-20px top-minus-20px w-250px sm-w-180px xs-w-150px opacity-1"><img src="/public/images/hardware-network/hardware-network-icon.webp" alt="Hardware Network and AMC Icon"></div>
                                                        ...
                                                        <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                            <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-01" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                                <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                                    <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Computer Hardware Solutions</span>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        <div id="accordion-style-02-01" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                            <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                                <p><b>We supply and support a wide range of branded and assembled computer hardware, including:</b><br><br>

<ul>
  <li>Desktops, Laptops & Workstations (Dell, HP, Lenovo, etc.)</li>
  <li>Servers and Storage Devices</li>
  <li>Printers, Scanners, UPS & Peripherals</li>
  <li>Custom PC Builds for High-Performance Use</li>
  <li>Licensed Software & Operating Systems</li>
</ul>

Whether you're setting up a new office or upgrading existing systems, we provide quality hardware at competitive prices with full installation and support.
<br />
                                                    ...
                                                    <div class="accordion-item">
                                                        <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                            <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-02" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                                <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                                    <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Networking Solutions</span>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        <div id="accordion-style-02-02" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                            <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                                <p class="w-90 sm-w-95 xs-w-100"><b>Robust networking is the backbone of any modern business. We design, deploy, and maintain secure and scalable network infrastructures:</b><br><br>

<ul>
  <li>LAN/WAN Setup & Configuration</li>
  <li>Switches, Routers, Firewalls (Fortinet, Sophos)</li>
  <li>Structured Cabling & Rack Management</li>
  <li>Wireless Network Design & Optimization</li>
  <li>Network Security & VPN Setup</li>
</ul>

Our solutions ensure high-speed connectivity, data protection, and maximum uptime for smooth business operations.
</br>
  </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                            <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-03" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                                <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                                    <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Annual Maintenance Contract (AMC)</span>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        <div id="accordion-style-02-03" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                            <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                                <p class="w-90 sm-w-95 xs-w-100"><b>Stay worry-free with our cost-effective and reliable AMC plans. We ensure your IT assets are always in top condition through:</b><br>

<ul>
  <li>Regular Preventive Maintenance</li>
  <li>On-site & Remote Support</li>
  <li>Quick Troubleshooting & Repairs</li>
  <li>Hardware Replacement Assistance</li>
  <li>Priority Response & Scheduled Health Checks</li>
</ul>

We offer flexible AMC packages - quarterly, half-yearly, or annual - for Network, Desktops, Laptops, and Servers.
