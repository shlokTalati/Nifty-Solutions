    <!-- start section -->
    <section class="full-screen ipad-top-space-margin sm-h-600px" data-parallax-background-ratio="0.5" style="background-image: url(https://placehold.co/1920x1200)">
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="one-fourth-screen border-radius-6px lg-border-radius-0px border border-color-transparent" data-parallax-background-ratio="0.5" style="background-image: url(https://placehold.co/1920x1100)"></section>
        <!-- end section -->
        <!-- start section -->
        <section>
            <div class="container">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <img src="https://placehold.co/1190x750" class="w-100 mb-7 border-radius-5px" alt="">
                        <img src="https://placehold.co/1190x750" class="w-100 border-radius-5px" alt="">
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="blog-image">
                                        <a href="demo-it-business-blog-single-clean.html" class="d-block"><img src="https://placehold.co/600x430" alt="" /></a>
                                ...
                                <ul class="child-comment">
                                    ...
                                    <li>
                                        <div class="d-block d-md-flex w-100 align-items-center align-items-md-start border-radius-5px p-50px md-p-30px sm-p-20px bg-very-light-gray">
                                            ...
                                            <div class="w-100 ps-30px last-paragraph-no-margin sm-ps-0">
                                                <a href="#" class="text-dark-gray text-dark-gray-hover fw-600">Colene Landin</a>
                                                <a href="#comments" class="btn-reply text-uppercase section-link">Reply</a>
