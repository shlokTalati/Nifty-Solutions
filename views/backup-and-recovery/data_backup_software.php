...
<!-- start page title -->
    <section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/databackup/databackup-inner.webp');">
            ...
            <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <figure class="position-relative m-0">
                        <img src="/public/images/databackup/databackup1.webp" alt="Data Backup" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-md-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <h3 class="text-dark-gray fw-700 ls-minus-1px">Automatic backup of File/Folder, Drive Image, Database, VMs, Microsoft 365, Exchange, Teams,OneDrive, SharePoint to Any local OR Cloud storage</h3>
                    ...
                    <div class="w-100 min-h-300px text-center rotate-box to-left">
                        ...
                        <div class="w-100 h-100 overflow-hidden z-index-1 front-side bg-white border-radius-6px box-shadow-quadruple-large">
                            <div class="rotate-content-front z-index-2 p-30px">
                                ...
                                <span>Iperius Backup is a lightweight, affordable software for secure data backup, cloud storage, and disaster recovery—ideal for businesses.</span>
                            </div>
                        </div>
                        <!-- end front side -->
                        <!-- start back side -->
                    ...
                    <div class="w-100 min-h-300px text-center rotate-box to-left">
                        ...
                        <div class="w-100 h-100 overflow-hidden z-index-1 front-side bg-white border-radius-6px box-shadow-quadruple-large">
                            <div class="rotate-content-front z-index-2 p-30px">
                                ...
                                <span>NovaBACKUP delivers reliable, automatic data protection with local and cloud backup for small businesses.</span>
                            </div>
                        </div>
                        <!-- end front side -->
                        <!-- start back side -->
                            ...
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner">
                                        <img src="/public/images/databackup/databackup-draw.webp" alt="Data Backup Drawing" class="border-radius-6px w-100" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="absolute-middle-center text-white-space-nowrap z-index-9">
                            <a class="nav-link fake-link" rel="nofollow" class="d-none btn btn-extra-large btn-white left-icon btn-box-shadow fw-600 btn-rounded popup-youtube ls-minus-05px"><i class="fa-brands fa-youtube icon-small"></i>How it works</a>
                        </div>
                    </div>
                </div>
