...
<!-- start page title -->
    <section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/disaster-recovery/disaster-recovery-inner.webp');">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center h-500px sm-h-300px">
                <div class="col-12 col-lg-8 col-md-10 position-relative text-center page-title-extra-large d-flex flex-wrap flex-column align-items-center justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <h1 class="mb-0 text-white fw-600 ls-minus-1px">Disaster Recovery</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <figure class="position-relative m-0">
                        <img src="/public/images/disaster-recovery/disaster-recovery1.webp" alt="Disaster Recovery" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    ...
                    <div class="w-100 min-h-300px text-center rotate-box to-left">
                        ...
                        <div class="w-100 h-100 overflow-hidden z-index-1 front-side bg-white border-radius-6px box-shadow-quadruple-large">
                            <div class="rotate-content-front z-index-2 p-30px">
                                ...
                                <span>Acronis Disaster Recovery delivers fast, automated recovery, minimizing downtime and ensuring business continuity with secure, scalable infrastructure.</span>
                            </div>
                        </div>
                        <!-- end front side -->
                        <!-- start back side -->
                        <div class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large" style="background-image:url('/public/images/disaster-recovery/acronis.webp')">
                            ...
                            <div class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                                ...
                                <a href="https://www.acronis.com/en-sg/products/cloud/cyber-protect/disaster-recovery/" target="_blank" class="btn btn-medium btn-rounded with-rounded btn-base-color btn-box-shadow">Learn more<span class="bg-white text-base-color"><i class="feather icon-feather-arrow-right"></i></span></a>
                            </div>
                            <!-- end back side -->
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
                            <div class="col-xl-5 col-lg-6 col-md-12 md-mb-50px" data-anime='{ "el": "childs", "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                                ...
                                <h3 class="fw-700 text-dark-gray ls-minus-1px">Benefits of using Disaster Recovery</h3>
                                    ...
                                    <div class="atropos-scale">
                                        <div class="atropos-rotate">
                                            <div class="atropos-inner">
                                                <img src="/public/images/disaster-recovery/disaster-recovery-draw.webp" alt="Disaster Recovery Drawing" class="border-radius-6px w-100" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                      ...
                      <div class="row align-items-center sm-mt-40px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="col-12">
                                <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                                    <div class="position-absolute right-70px lg-right-20px top-minus-20px w-250px sm-w-180px xs-w-150px opacity-1"><img src="/public/images/disaster-recovery/disaster-recovery-icon.webp" alt="Disaster Recovery Icon"></div>
                                    <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-light-gray-transparent d-inline-flex"><i class="bi bi-patch-check fs-16 me-5px"></i>Basic information of Disaster Recovery</span>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="accordion-style-02-01" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p> <b>Acronis Cyber Protect Cloud with Advanced Disaster Recovery</b><br><br>

The Acronis Cyber Protect Cloud with Advanced Disaster Recovery offers a comprehensive solution for businesses aiming to ensure business continuity and minimize downtime during unexpected disruptions.<br><br>

<b>Core Benefits:</b><br><br>

<ul>
  <li><b>Instant Recovery:</b> Spin up client systems in the Acronis Cloud within minutes to reduce downtime.</li>
  <li><b>Comprehensive Protection:</b> One solution manages data, systems, and apps from a unified interface.</li>
  <li><b>Increased Revenue:</b> Add value and grow your monthly recurring revenue by offering DR as a service.</li>
</ul><br>

<b>Standard Features (Acronis Cyber Protect Cloud):</b><br><br>

<ul>
  <li>File, image, and application backup</li>
  <li>Local recovery with Instant Restore</li>
  <li>Test failover</li>
  <li>Cloud-only VPN connection</li>
</ul><br>

<b>Key Features of Acronis Advanced Disaster Recovery:</b><br><br>

<ul>
  <li><b>Rapid Recovery:</b> Quickly restore operations in just a few clicks without any upfront investments, enabling swift recovery from ransomware attacks, hardware failures, or other disruptions.</li>
  <li><b>Integrated Cyber Protection:</b> Combines backup, disaster recovery, AI-based malware protection, and endpoint management into a single solution, reducing complexity and operational costs.</li>
  <li><b>Malware-Free Recoveries:</b> Ensures that failovers are to clean, malware-free recovery points, preventing reinfection and enhancing security.</li>
  <li><b>Flexible Deployment Options:</b> Supports various deployment scenarios, including VPN-less deployment and IPsec multisite VPN support, catering to diverse network configurations.</li>
  <li><b>Automated Orchestration:</b> Utilizes runbooks to automate disaster recovery procedures, simplifying failover and failback processes for physical/virtual machines.</li>
