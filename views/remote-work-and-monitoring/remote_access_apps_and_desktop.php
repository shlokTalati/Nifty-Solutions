        ...
        <div class="container">
            <div class="row align-items-center justify-content-center h-500px sm-h-300px">
                <div class="col-12 col-lg-8 col-md-10 position-relative text-center page-title-extra-large d-flex flex-wrap flex-column align-items-center justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <span class="ps-25px pe-25px pt-5px pb-5px mb-15px text-uppercase text-white fs-12 ls-1px fw-600 border-radius-100px bg-gradient-dark-gray-transparent d-flex"><i class="bi bi-megaphone text-white icon-small me-10px"></i>Secure Remote Access Solution</span>
                    <h1 class="mb-0 text-white fw-600 ls-minus-1px">Remote Access Solutions</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-md-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex justify-content-center justify-content-md-start"><i class="bi bi-award fs-16 me-5px"></i>TSPlus Remote Access</span>
                    <h3 class="text-dark-gray fw-700 ls-minus-1px">Remote Desktop Access Solution</h3>
                    <p class="w-95 md-w-100">We are an authorized partner of TSPlus (www.tsplus.net). TSPlus is one of the leading brands globally since 2007, providing Remote Access for application access and folder/data access as per user rights. More than 500,000+ customers access their data remotely using TSPlus application. License available as Perpetual/Lifetime license.
                    </p>
                    <div class="pt-20px pb-20px ps-30px pe-30px xs-p-15px border border-color-extra-medium-gray border-radius-6px mb-15px icon-with-text-style-08 w-90 lg-w-100">
                        ...
                        <p class="fs-13 mb-0">We are excited to bring you enterprise-grade remote access solutions that <span class="text-dark-gray text-decoration-line-bottom">securely</span> connect your business.</p>
                    </div>
                </div>
            </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center mb-3">
                <div class="col-xl-8 col-lg-9 col-md-10 text-center">
                    <h3 class="text-dark-gray fw-700 ls-minus-1px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>TSPlus Remote Access Features</h3>
                </div>
            </div>
                    ...
                    <div class="w-100 min-h-300px text-center rotate-box to-left">
                        ...
                        <div class="w-100 h-100 overflow-hidden z-index-1 front-side bg-white border-radius-6px box-shadow-quadruple-large">
                            <div class="rotate-content-front z-index-2 p-30px">
                                ...
                                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">Remote Desktop Access</div>
                                <span></span>
                            </div>
                        </div>
                        <!-- end front side -->
                        ...
                        <div class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large" style="background-image:url('/public/images/antivirus-escan1.jpg')">
                            ...
                            <div class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                                <span class="text-white alt-font fw-500 fs-19 mb-5px">The ideal alternative to Citrix and Microsoft RDS for remote desktop access and Windows application delivery.</span>
                    ...
                    <div class="w-100 min-h-300px text-center rotate-box to-left">
                        ...
                        <div class="w-100 h-100 overflow-hidden z-index-1 front-side bg-white border-radius-6px box-shadow-quadruple-large">
                            <div class="rotate-content-front z-index-2 p-30px">
                                ...
                                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">Application Publishing</div>
                                <span></span>
                            </div>
                        </div>
                        <!-- end front side -->
                        ...
                        <div class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large" style="background-image:url('/public/images/antivirus-bitdefender1.jpg')">
                            <div class="opacity-light bg-charcoal-blue"></div>
                            <div class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                                <span class="text-white alt-font fw-500 fs-19 mb-5px">Application Publishing</span>
                                <p></p>
                                <a href="https://tsplus.net/" target="_blank" class="btn btn-medium btn-rounded with-rounded btn-base-color btn-box-shadow">Learn more<span class="bg-white text-base-color"><i class="feather icon-feather-arrow-right"></i></span></a>
                            </div>
                            <!-- end back side -->
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
                            <div class="col-xl-5 col-lg-6 col-md-12 md-mb-50px" data-anime='{ "el": "childs", "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                                <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex"><i class="bi bi-patch-check fs-16 me-5px"></i>Solution benefits</span>
                                <h3 class="fw-700 text-dark-gray ls-minus-1px">Benefits of TSPlus Remote Access</h3>
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Secure Application Access</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">User-Based Security Policies</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Controlled Data Access</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                ...
                                <div class="icon-with-text-style-08 mb-10px">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Universal Printing Capability</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                                ...
                                <div class="icon-with-text-style-08">
                                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                        ...
                                        <div class="feature-box-content">
                                            <span class="text-dark-gray fw-500">Perpetual License Option</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end features box item -->
                        ...
                        <div class="row align-items-center mt-8 sm-mt-40px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="col-12">
                                <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                                    ...
                                    <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-light-gray-transparent d-inline-flex"><i class="bi bi-patch-check fs-16 me-5px"></i>TSPlus Remote Access Features</span>
                                    <h3 class="fw-700 text-dark-gray ls-minus-1px">Key Capabilities</h3>
                                            ...
                                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-01" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Remote Desktop Access</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div id="accordion-style-02-01" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p><strong>Remote Desktop Access</strong> provides your remote and local users access to centralized Windows applications on a full remote desktop, specific application OR folders as per company data security policy to specific user OR group. It also supports concurrent Remote Desktop (RDS) connections using HTML5 or any RDP compatible clients.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-02" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Application Publishing</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div id="accordion-style-02-02" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p class="w-90 sm-w-95 xs-w-100"><strong>Application Publishing</strong> allows you to publish applications and enable users to remotely access them as if they were natively installed on their machine. Users access the remote apps from customizable launch menus or shortcuts on their desktops.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-03" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Application Assigning</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div id="accordion-style-02-03" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p class="w-90 sm-w-95 xs-w-100"><strong>Application Assigning</strong> - Once you have published some applications, you can assign them to one or more users or groups. Administrators can assign applications based on Active Directory, local accounts, Azure or AWS.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-04" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Data Download Restriction</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div id="accordion-style-02-04" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p class="w-90 sm-w-95 xs-w-100"><strong>Data Download Restriction</strong> allows you to restrict your users from downloading data from remote server to local laptop/desktop for company data security.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-05" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">RDP Client</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div id="accordion-style-02-05" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p class="w-90 sm-w-95 xs-w-100"><strong>RDP Client</strong> - TSplus Remote Access is compatible with any RDP client. Your concurrent users will have access to a standard Windows desktop with its shortcuts, start menu and task bar. Use the TSplus RDP client generator to enable a 1-click connection experience for your users.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                                <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-06" aria-expanded="false" data-bs-parent="#accordion-style-02">
                                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                        <i class="feather icon-feather-plus fs-20"></i><span class="fs-17 fw-500">Universal Printer</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div id="accordion-style-02-06" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                                    <p class="w-90 sm-w-95 xs-w-100"><strong>Universal Printer</strong> - TSplus Universal Printer enables you to print from any location, without having to install any specific printer driver. The document to print will be converted into a PDF file and automatically pushed to the user device.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
