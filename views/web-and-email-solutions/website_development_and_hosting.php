<?php $page_title = "Web Developement & Hosting";
...
<!-- start page title -->
    <section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/wed-hosting/web-hosting-inner.webp');">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center h-500px sm-h-300px">
                    <div class="col-12 col-lg-8 col-md-10 position-relative text-center page-title-extra-large d-flex flex-wrap flex-column align-items-center justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <h1 class="mb-0 text-white fw-600 ls-minus-1px">Professional Web Development & Hosting</h1>
                    </div> 
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                    <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <figure class="position-relative m-0">
                            <img src="/public/images/wed-hosting/web-hosting1.webp" alt="Web Hosting and Development" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                            <figcaption class="w-190px sm-w-180px xs-w-140px bg-white p-30px xs-p-15px border-radius-6px position-absolute bottom-30px left-30px xs-bottom-20px xs-left-15px overflow-hidden box-shadow-medium animation-float text-center" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 1000, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                                <span class="fs-90 xs-fs-80 fw-700 text-white d-block position-relative z-index-1">2</span>
                    ...
                    <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-md-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <span class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-12 lh-40 fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-flex justify-content-center justify-content-md-start"><i class="bi bi-award fs-16 me-5px"></i>Web</span>
                        <h3 class="text-dark-gray fw-700 ls-minus-1px">Professional and dedicated Web Services.</h3>
                        <p class="w-95 md-w-100">Crafting visually stunning, high-performance websites — and hosting them reliably — all in one place.</p>
                        <div class="pt-20px pb-20px ps-30px pe-30px xs-p-15px border border-color-extra-medium-gray border-radius-6px mb-15px icon-with-text-style-08 w-90 lg-w-100">
                            <div class="feature-box feature-box-left-icon-middle d-inline-flex align-middle">
                                ...
                                <div class="feature-box-content">
                                    <span class="fs-17 alt-font fw-600 text-dark-gray d-block lh-26">Over a Decade of Trusted Web Design</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h5 class="alt-font text-dark-gray fw-600">Why choose Nifty Solutions?</h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-6 md-mb-15px">
                        <div class="bg-white p-40px sm-p-30px last-paragraph-no-margin box-shadow-small">
                            <h5 class="text-dark-gray">Over a Decade of Trusted Web Design</h5>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 md-mb-15px">
                        <div class="bg-white p-40px sm-p-30px last-paragraph-no-margin box-shadow-small">
    ...
    <br>
                <div class="row">
                    <div class="col-12 col-lg-6 md-mb-15px">
                        ...
                        <div class="col-12 col-lg-6 md-mb-15px">
                        <div class="bg-white p-40px sm-p-30px last-paragraph-no-margin box-shadow-small">
                            <h5 class="text-dark-gray">Need a Domain? We’ve Got You Covered</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner">
                                        <img src="/public/images/wed-hosting/web-hosting-draw.webp" alt="Web Hosting and Development Drawing" class="border-radius-6px w-100"/>
                                    </div>
                                </div> 
                            </div>
                        </div> 
                ...
                <div class="row align-items-center mt-8 sm-mt-40px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-12">
                        <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                            <div class="position-absolute right-70px lg-right-20px top-minus-20px w-250px sm-w-180px xs-w-150px opacity-1"><img src="/public/images/wed-hosting/web-hosting-icon.webp" alt="Web Hosting and Development Icon"></div>
