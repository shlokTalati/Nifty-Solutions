    ...
    <section class="pt-0 cover-background ipad-top-space-margin sm-pb-0" style="background-image:url('/public/images/bulk-smtp/bulk-inner.png');">
                ...
                <div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
                    <div class="col-lg-6 md-mb-50px" data-anime='{ "translateY": [0, 0], "zoom": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <figure class="position-relative m-0">
                            <img src="/public/images/bulk-smtp/bulk1.jpg" alt="" class="w-100 border-radius-5px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <div class="pt-20px pb-20px ps-30px pe-30px xs-p-15px border border-color-extra-medium-gray border-radius-6px mb-15px icon-with-text-style-08 w-90 lg-w-100">
                            <div class="feature-box feature-box-left-icon-middle d-inline-flex align-middle">
                                ...
                                <div class="feature-box-content">
                                    <span class="fs-17 alt-font fw-600 text-dark-gray d-block lh-26">10k+ people trusting the agency.</span>
                                </div>
                            </div>
                        </div>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 align-items-center justify-content-center mt-5 xs-mt-7" data-anime='{ "el": "childs", "translateY":[0, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 100, "easing": "easeOutQuad" }'>
                            ...
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner">
                                        <img src="/public/images/bulk-smtp/mail-draw.jpg" alt="" class="border-radius-6px w-100"/>
                                    </div>
                                </div> 
                            </div>
                        </div> 
                ...
                <div class="row align-items-center mt-8 sm-mt-40px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-12">
                        <div class="bg-very-light-gray p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                            <div class="position-absolute right-70px lg-right-20px top-minus-20px w-250px sm-w-180px xs-w-150px opacity-1"><img src="/public/images/bulk-smtp/bulk-icon.png" alt=""></div>
                                    ...
                                    <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                        <a href="#" data-bs-toggle="collapse" data-bs-target="#accordion-style-02-01" aria-expanded="true" data-bs-parent="#accordion-style-02">
                                            <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                                <i class="feather icon-feather-minus fs-20"></i><span class="fs-17 fw-500">Bulk Email SMTP Service for Businesses</span>
                                            </div>
                                        </a>
                                    </div>
...
Our SMTP service is tailored for small to medium-sized businesses to reliably send large volumes of marketing emails and newsletters.<br><br>

<b>Key Features:</b><br><br>
<ul>
  <li><b>Multiple Secured Ports Supported:</b><br>
  SMTP available on port 465 and 587, ensuring smooth operation even if one port is blocked by your ISP or firewall.</li><br>

  <li><b>Easy Integration:</b><br>
  Use our SMTP credentials (Host, Username, Password) with any email client or bulk email software.</li><br>

  <li><b>Use Your Own Domain/Email:</b><br>
  Send emails using your own domain and email address, such as name@yourdomain.com. This enhances brand credibility and email deliverability.</li><br>

  <li><b>Flexible Quotas:</b><br>
  Purchase email quotas as per your monthly requirement. No daily sending restrictions!</li><br>

  <li><b>High Deliverability:</b><br>
  Designed for lightning-fast and reliable email delivery to inboxes�not spam folders.</li>
</ul><br>
...
<ul>
  ...
  <li>To send transactional emails from your ERP / CRP / Tally or any such application</li>
</ul><br>

<b>Why Choose Our SMTP Service?</b><br><br>
<ul>
  <li>Fully authenticated with SPF, DKIM, and DMARC support</li>
  <li>Compatible with any email marketing software (like MailWizz, SendBlaster, Gammadyne, etc.)</li>
            ...
            <div class="container overlap-gap-section">
                <div class="row justify-content-center mb-4">
                    <div class="col-xl-7 col-lg-9 col-md-10 text-center">
                        <h3 class="text-dark-gray fw-700 ls-minus-2px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>Other business services</h3>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center mb-8" data-anime='{ "el": "childs", "translateY": [50, 0], "translateX": [-30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <div class="col"> 
                        <div class="services-box-style-03 box-shadow-extra-large last-paragraph-no-margin border-radius-6px overflow-hidden">
                            ...
                            <div class="bg-white">
                                <div class="ps-65px pe-65px lg-ps-30px lg-pe-30px pt-30px pb-30px text-center">
                                    <a href="demo-it-business-services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">3</a>
                                    <p>text to be given by Manav / Shlok</p> 
                                </div> 
                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                    <a href="demo-it-business-services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
